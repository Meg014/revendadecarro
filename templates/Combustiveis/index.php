 ...
 * @var iterable<\App\Model\Entity\Combustivei> $combustiveis
 */
?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-list flex-nowrap">
                                                    ...
                                                    <a type="button" title="Editar" class="btn" data-bs-toggle="modal" data-bs-target="#modal-edit<?= $combustivei['id'] ?>">
                                                    ...
                                                    <div class="modal modal-blur fade" id="modal-edit<?= $combustivei['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        <?= $this->Form->control('nome_edit', [
                                                                            'label' => 'Nome',
                                                                            'value' => $combustivei['nome'],
                                                                            'class' => 'form-control',
                                                                            'placeholder' => 'Digite o nome',
                                                                            'required' => true
                                                                        ]) ?>

                                                                        <?= $this->Form->hidden('id', ['value' => $combustivei['id']]) ?>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <a type="button" title="Excluir" class="btn" data-bs-toggle="modal" data-bs-target="#modal-delete<?= $combustivei['id'] ?>">
                                                    ...
                                                    <div class="modal modal-blur fade" id="modal-delete<?= $combustivei['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center py-4">
                                                                    ...
                                                                    <input type="hidden" name="id_excluir" value="<?= $combustivei['id'] ?>">
                                                                    <div class="text-secondary">Certeza que deseja excluir <?= $combustivei['nome'] ?>?</div>
                                                                </div>
