                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-list flex-nowrap">
                                                    ...
                                                    <a type="button" title="Editar" class="btn" data-bs-toggle="modal" data-bs-target="#modal-edit<?= $feature['id'] ?>">
                                                    ...
                                                    <div class="modal modal-blur fade" id="modal-edit<?= $feature['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <?= $this->Form->hidden('id', ['value' => $feature['id']]) ?>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <!-- <a type="button" title="Excluir" class="btn" data-bs-toggle="modal" data-bs-target="#modal-delete<?= $feature['id'] ?>">
                                                    ...
                                                    <div class="modal modal-blur fade" id="modal-delete<?= $feature['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center py-4">
                                                                    ...
                                                                    <input type="hidden" name="id_excluir" value="<?= $feature['id'] ?>">
                                                                    <div class="text-secondary">Certeza que deseja excluir <?= $feature['nome'] ?>?</div>
                                                                </div>
