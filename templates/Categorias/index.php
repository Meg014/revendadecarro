                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-list flex-nowrap">
                                                    ...
                                                    <a type="button" title="Editar" class="btn" data-bs-toggle="modal" data-bs-target="#modal-edit<?= $categoria['id'] ?>">
                                                    ...
                                                    <div class="modal modal-blur fade" id="modal-edit<?= $categoria['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                            <div class="modal-content">

                                                                <?= $this->Form->create(null, ['url' => ['controller' => 'Categorias', 'action' => 'index']]) ?>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <?= $this->Form->hidden('id', ['value' => $categoria['id']]) ?>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <a type="button" title="Excluir" class="btn" data-bs-toggle="modal" data-bs-target="#modal-delete<?= $categoria['id'] ?>">
                                                    ...
                                                    <div class="modal modal-blur fade" id="modal-delete<?= $categoria['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center py-4">
                                                                    ...
                                                                    <input type="hidden" name="id_excluir" value="<?= $categoria['id'] ?>">
                                                                    <div class="text-secondary">Certeza que deseja excluir a categoria <?= $categoria['nome'] ?>?</div>
                                                                </div>
