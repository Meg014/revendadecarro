    ...
    <div class="column-responsive column-80">
        <div class="users view content">
            ...
            <table>
                ...
                <tr>
                    <th><?= __('Role') ?></th>
                    <td><?= $user->has('role') ? $this->Html->link($user->role->description, ['controller' => 'Roles', 'action' => 'view', $user->role->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?= h($sessionsLogins->login_time) ?></td>
                            <td><?= h($sessionsLogins->created_at) ?></td>
                            <td><?= h($sessionsLogins->updated_at) ?></td>
                            <td class="actions">
