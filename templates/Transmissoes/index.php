 ...
 * @var iterable<\App\Model\Entity\Transmisso> $transmissoes
 */
?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table">
                                <thead>
                                  ...
                                  <tbody>
                                    <?php foreach ($transmissoes as $transmissoe) : ?>
                                        <tr>
                                            <td><?= $transmissoe['id'] ?></td>
                                            ...
                                            <td>
                                                <div class="btn-list flex-nowrap">
                                                    ...
                                                    <a type="button" title="Editar" class="btn" data-bs-toggle="modal" data-bs-target="#modal-edit<?= $transmissoe['id'] ?>">
                                                    ...
                                                    <div class="modal modal-blur fade" id="modal-edit<?= $transmissoe['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        <?= $this->Form->control('nome_edit', [
                                                                            'label' => 'Nome',
                                                                            'value' => $transmissoe['nome'],
                                                                            'class' => 'form-control',
                                                                            'placeholder' => 'Digite o nome',
                                                                            'required' => true
                                                                        ]) ?>

                                                                        <?= $this->Form->hidden('id', ['value' => $transmissoe['id']]) ?>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <a type="button" title="Excluir" class="btn" data-bs-toggle="modal" data-bs-target="#modal-delete<?= $transmissoe['id'] ?>">
                                                    ...
                                                    <div class="modal modal-blur fade" id="modal-delete<?= $transmissoe['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center py-4">
                                                                    ...
                                                                    <input type="hidden" name="id_excluir" value="<?= $transmissoe['id'] ?>">
                                                                    <div class="text-secondary">Certeza que deseja excluir <?= $transmissoe['nome'] ?>?</div>
                                                                </div>
