                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-list flex-nowrap">
                                                    ...
                                                    <a type="button" title="Editar" class="btn" data-bs-toggle="modal" data-bs-target="#modal-edit<?= $modelo['id'] ?>">
                                                    ...
                                                    <div class="modal modal-blur fade" id="modal-edit<?= $modelo['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <?= $this->Form->control('marca_id', [
                                                                                    'label' => 'Marcas',
                                                                                    'type' => 'select',
                                                                                    'options' => \Cake\Utility\Hash::combine($getMarcas, '{n}.id', '{n}.nome'),
                                                                                    'value' => $modelo['marca_id'], // precisa ser o ID da marca
                                                                                    'empty' => false, // remove o "Selecione uma marca"
                                                                                    'class' => 'form-select',
                                                                                    'required' => true
                                                                                ]) ?>
                                                                        ...
                                                                        <?= $this->Form->hidden('id', ['value' => $modelo['id']]) ?>
                                                    ...
                                                    <a type="button" title="Excluir" class="btn" data-bs-toggle="modal" data-bs-target="#modal-delete<?= $modelo['id'] ?>">
                                                    ...
                                                    <div class="modal modal-blur fade" id="modal-delete<?= $modelo['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center py-4">
                                                                    ...
                                                                    <input type="hidden" name="id_excluir" value="<?= $modelo['id'] ?>">
                                                                    <div class="text-secondary">Certeza que deseja excluir <?= $modelo['nome'] ?>?</div>
                                                                </div>
